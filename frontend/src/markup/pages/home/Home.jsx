...
import Image from "../../../../src/assets/templateassets/images/custom/banner/banner1.jpg";
...
import Service from "../../components/ui/ServicesSection";
  ...
  return (
    <>
      <div className="page-wrapper">
        {/* page title*/}
        <Pagetitle
          title="Tuneup Your Car"
          subtitle="to Next Level"
          smallText="Working since 1992"
          background={Image}
          showVideo={true}
        />
        {/* WORK SHOP */}
